...
Subplot_setup_dict_type_default = {'name':['string','new subplot'],'location':['int_list',[1,1]],'plotsubB':['bool', False], 'curvelist':['curve_list',[]], 'subplot_num':['int_list',[1,1]],'setup_grid':['int_list',[1,1]]}
...
#	print 'After qrange.'
    ...
    def get_fit(self):
        ...
        for i, para in enumerate(self.para_list_fit):
            self.fit_result_string = self.fit_result_string + "{0:.3e}".format(para) + '\t' + "{0:.3e}".format(self.error_list_fit[i]) + '\n'
